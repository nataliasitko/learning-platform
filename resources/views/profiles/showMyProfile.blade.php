...
{{--                <div class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center" style="background-image: url('{{Auth::user()->url}}')"></div>--}}
...
{{--                </div>--}}
        ...
        <div class="w-full lg:w-2/5">
            ...
            <img src="{{Auth::user()->url}}" class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block">
