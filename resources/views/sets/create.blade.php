...
{{--                        <td><input x-model="field.txt1" type="text" name="txt1[]" class="stored form-control"></td>--}}
{{--                        <td><input x-model="field.txt2" type="text" name="txt2[]" class="stored form-control"></td>--}}
...
{{--                <tfoot>--}}
{{--                <tr>--}}
{{--                    <td colspan="4" class="text-right"><button type="button" class="btn btn-info" @click="addNewField(index)">+ Add</button></td>--}}
{{--                </tr>--}}
{{--                </tfoot>--}}
{{--            </table>--}}
                ...
                <form>
                    <div class="mb-4 w-full bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <div class="py-2 px-4 bg-white rounded-b-lg dark:bg-gray-800">
                            <label for="editor" class="sr-only">Create</label>
